...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'questionOptionSelectedId' => [
            'required' => 'Ответ обязательно должен быть выбран.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'terms' => 'Условия',
        'role_selected' => 'Роль',
        'organization_selected_id' => 'БИН организации',
        'region_selected_id' => 'Регион',
        'district_selected_id' => 'Район',
        'generalCharacteristics' => 'Общая характеристика',
        'iin' => 'ИИН',
        'birthday' => 'Дата рождения',
        'phone' => 'Телефон',
        'classroom_id' => 'Класс',
        'classRoomSelected' => 'Класс',
        'classNumberSelected' => 'Класс',
        'classLetterSelected' => 'Литера',
        'languageSelected' => 'Язык обучения',
        'specialMarks' => 'Особые отметки',
        'incidents' => 'Приводы в полицию, инциденты',
        'specialStatusSelected' => 'Особый статус',
        'form.tmpDocuments.1' => 'Документы инцидентов',
        'form.tmpDocuments.1.*' => 'Документы инцидентов',
        'form.tmpDocuments.2' => 'Успеваемость',
        'form.tmpDocuments.2.*' => 'Документы успеваемости',
        'form.tmpDocuments.3' => 'Портфолио',
        'form.tmpDocuments.3.*' => 'Документы портфолио',
        'form.tmpPhoto' => 'Фотография',
        'form.tmpPhoto.*' => 'Фотография',
        'form.questionOptionSelectedId' => 'Вариант ответа обязательно должен быть выбран',
    ],
